...
import org.example.menu.MenuRequestDTO;
        ...
        try {
            ...
            while (true) {
                ...
                switch (header[1]) {
                    ...
                    case 0x12 -> {
                        int dataLength = Utils.bytesToInt(header, 2);
                        data = new byte[dataLength];
                        dis.readFully(data);

                        responseDTO = ApplicationContext.getMenuController().getMenus(new MenuRequestDTO(data), userId);
                    ...
                    case 0x42 -> {
                        ...
                        responseDTO = ApplicationContext.getCouponController().getCoupons(userId);
                    }
